...
python3 training_data/mutate/generate.py "data/raw_collection/ftc_game_terms/mobile_2017.converted.hwpx" \
  --prompt v1.2 --plan "training_data/mutate/plans/archive/retry/ftc_game_terms__mobile_2017.converted.json" --concurrency 8
python3 training_data/mutate/generate.py "data/raw_collection/ftc_game_terms/mobile_2024.hwpx" \
  --prompt v1.2 --plan "training_data/mutate/plans/archive/retry/ftc_game_terms__mobile_2024.json" --concurrency 8
python3 training_data/mutate/generate.py "data/raw_collection/ftc_game_terms/online_2013.converted.hwpx" \
  --prompt v1.2 --plan "training_data/mutate/plans/archive/retry/ftc_game_terms__online_2013.converted.json" --concurrency 8
python3 training_data/mutate/generate.py "data/raw_collection/ftc_game_terms/online_2024.hwpx" \
  --prompt v1.2 --plan "training_data/mutate/plans/archive/retry/ftc_game_terms__online_2024.json" --concurrency 8
python3 training_data/mutate/generate.py "data/raw_collection/ftc_gift_certificate_terms/2020_standard_terms.converted.hwpx" \
  --prompt v1.2 --plan "training_data/mutate/plans/archive/retry/ftc_gift_certificate_terms__2020_standard_terms.converted.json" --concurrency 8
python3 training_data/mutate/generate.py "data/raw_collection/ftc_gift_certificate_terms/2024_standard_terms.hwpx" \
  --prompt v1.2 --plan "training_data/mutate/plans/archive/retry/ftc_gift_certificate_terms__2024_standard_terms.json" --concurrency 8
python3 training_data/mutate/generate.py "data/raw_collection/mof_rd_regulation_pair/after_2024.hwpx" \
  --prompt v1.2 --plan "training_data/mutate/plans/archive/retry/mof_rd_regulation_pair__after_2024.json" --concurrency 8
python3 training_data/mutate/generate.py "data/raw_collection/mof_rd_regulation_pair/before_2022.hwpx" \
  --prompt v1.2 --plan "training_data/mutate/plans/archive/retry/mof_rd_regulation_pair__before_2022.json" --concurrency 8
python3 training_data/mutate/generate.py "data/raw_collection/mois_opendata_eval_manual/2021_eval_manual.hwpx" \
  --prompt v1.2 --plan "training_data/mutate/plans/archive/retry/mois_opendata_eval_manual__2021_eval_manual.json" --concurrency 8
python3 training_data/mutate/generate.py "data/raw_collection/mss_rd_guideline_pair/after_2025.hwpx" \
  --prompt v1.2 --plan "training_data/mutate/plans/archive/retry/mss_rd_guideline_pair__after_2025.json" --concurrency 8
python3 training_data/mutate/generate.py "data/raw_collection/mss_rd_guideline_pair/before_2024.hwpx" \
  --prompt v1.2 --plan "training_data/mutate/plans/archive/retry/mss_rd_guideline_pair__before_2024.json" --concurrency 8
python3 training_data/mutate/generate.py "data/raw_collection/regional_industry_guideline_pair/after_2026.txt" \
  --prompt v1.2 --plan "training_data/mutate/plans/archive/retry/regional_industry_guideline_pair__after_2026.json" --concurrency 8
python3 training_data/mutate/generate.py "data/raw_collection/regional_industry_guideline_pair/before_2023.txt" \
  --prompt v1.2 --plan "training_data/mutate/plans/archive/retry/regional_industry_guideline_pair__before_2023.json" --concurrency 8
python3 training_data/mutate/generate.py "data/raw_collection/tips_operating_guideline_pair/after_2023_partial_revision.txt" \
  --prompt v1.2 --plan "training_data/mutate/plans/archive/retry/tips_operating_guideline_pair__after_2023_partial_revision.json" --concurrency 8
python3 training_data/mutate/generate.py "data/raw_collection/tips_operating_guideline_pair/before_2022.txt" \
  --prompt v1.2 --plan "training_data/mutate/plans/archive/retry/tips_operating_guideline_pair__before_2022.json" --concurrency 8
